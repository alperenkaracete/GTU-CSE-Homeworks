...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        boolean control;
        ArrayList<Building> side1Buildings = new ArrayList<>(), //allocating both sides building arrays
                side2Buildings = new ArrayList<>();
        ...
        ArrayList<ArrayList<Character>> streetSide1Array = new ArrayList<>(), //total height=50
                streetSide2Array = new ArrayList<>();
        for (int i=0;i<=52;i++){ //refilling arrays with spaces

            for (int j=0;j<=streetLength;j++){

                streetSide1Array.add(new ArrayList<>());
                streetSide2Array.add(new ArrayList<>());
                streetSide1Array.get(j).add(i,' ');
                streetSide2Array.get(j).add(i,' ');
            }
        }
            ...
            if (choice == 'E' || choice == 'e') {
                ...
                if (addOrDelete == 1) {
                    ...
                    if (side == 1) {
                        ...
                        if (buildingType == 1) {
                            ...
                            if (control) {
                                ...
                                drawStreet(streetSide1Array, side1Buildings, streetLength,side1buildingNumber-1);
                            }
                        }
                        if (buildingType == 2) {
                    ...
                    if (side == 2) { //for second side same processes
                        ...
                        if (buildingType == 1) {
                            ...
                            if (control) {
                                ...
                                drawStreet(streetSide2Array, side2Buildings, streetLength, side2buildingNumber-1);
                            }
                        }
                        if (buildingType == 2) {
                    ...
                    if (intChoice == 1) {
                        ...
                        deleteBuilding(streetSide1Array, side1Buildings.get(choice2));
                    }
                    ...
                    if (intChoice == 2) {
                        ...
                        deleteBuilding(streetSide2Array, side2Buildings.get(choice2));
                    }
                }
                ...
                if (intChoice == 5){
                    ...
                    for (int i=51;i>=0;i--){
                        ...
                        for (int j=0;j<=streetLength-1;j++){
                            ...
                            System.out.print(streetSide1Array.get(j).get(i));
                        }
                    }
                }
            }
    ...
    public static boolean makeStreet (ArrayList<Building> building,Building temp,int buildingNumber){ //looks building if it can be replaced to street
    ...
    public static void drawStreet (ArrayList<ArrayList<Character>> street, ArrayList<Building> building, int streetLength, int buildingCount){ // if building can be replaceable on street prints it on street
    ...
    public static void deleteBuilding (ArrayList<ArrayList<Character>> street, Building building){ // delete building from street
    ...
    public static void driverFunction () { //driver function makes objects and processes automatically
        ...
        ArrayList<ArrayList<Character>> streetSide1Array = new ArrayList<>(), //total height=50
                streetSide2Array = new ArrayList<>();
        ArrayList<Character> side1BuildingsOneDimension = new ArrayList<>(),
                side2BuildingsOneDimension = new ArrayList<>();
        ...
        for (int i=0;i<streetLength;i++) {
            streetSide1Array.add(side1BuildingsOneDimension);
            streetSide2Array.add(side1BuildingsOneDimension);
            }
        ...
        deleteBuilding(streetSide2Array, side2Buildings.get(side2buildingNumber - 1)); //deletes building from street
